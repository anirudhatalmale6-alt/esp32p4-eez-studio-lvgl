...
#include "sdkconfig.h"              // Project configuration generated by menuconfig

#include "freertos/FreeRTOS.h"      // FreeRTOS core definitions
#include "freertos/task.h"          // FreeRTOS task management

#include "esp_log.h"                // ESP-IDF logging system
#include "esp_idf_version.h"        // ESP-IDF version macros and checks

#include "esp_lcd_panel_ops.h"      // Generic LCD panel operation interface
#include "esp_lcd_panel_io.h"       // LCD communication interfaces (SPI, DSI, etc.)
#include "esp_lcd_mipi_dsi.h"       // MIPI-DSI interface driver (used by ESP32-P4 displays)
#include "esp_lcd_panel_vendor.h"   // Vendor-specific LCD panel helper functions

#include "esp_ldo_regulator.h"      // Control of internal LDO regulator for peripherals

#include "esp_lcd_touch_gt911.h"    // Driver for GT911 touch controller (I2C)
#include "esp_lcd_jd9365.h"         // Driver for JD9365 LCD display (MIPI DSI)

#include "esp_lvgl_port.h"          // Official LVGL port layer for ESP-IDF
#include "lvgl.h"                   // LVGL graphics library

#include "driver/i2c_master.h"      // I2C master driver (used for GT911 touch controller)

#include "driver/gpio.h"            // GPIO control (digital input/output pins)
#include "driver/ledc.h"            // Hardware PWM using LEDC (commonly for LCD backlight)
...
#define TOUCH_I2C_RST           (GPIO_NUM_6)
